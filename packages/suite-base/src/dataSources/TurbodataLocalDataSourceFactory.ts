...
class TurbodataLocalDataSourceFactory implements IDataSourceFactory {
  public id = "turbodata-local-file";
  public type: IDataSourceFactory["type"] = "file";
  public displayName = "turbodata";
  public iconName: IDataSourceFactory["iconName"] = "OpenFile";
  public supportedFileTypes = [AllowedFileExtensions.TD];
...
export default TurbodataLocalDataSourceFactory;
